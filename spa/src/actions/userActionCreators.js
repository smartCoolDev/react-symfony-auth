...
export function confirmAccountActivation(token: string): Function {
  return (
    dispatch: Dispatch<AccountActivationConfirmationAction>
  ): Promise<void> =>
    updateAccountActivation(token).then((response) => {
      switch (response.status) {
        case 200:
          dispatch({
            type: APP_NOTIFICATIONS_ADD,
...
export function resetPassword(
  ...
  return (dispatch: Dispatch<PasswordResetAction>): Promise<void> =>
    updatePasswordReset(token, formData).then((response) => {
      switch (response.status) {
        case 200:
          dispatch({
            type: APP_NOTIFICATIONS_ADD,
...
export function confirmEmailChange(token: string): Function {
  return (dispatch: Dispatch<EmailChangeConfirmationAction>): Promise<void> =>
    updateEmailChange(token).then((response) => {
      switch (response.status) {
        case 200:
          dispatch({
            type: APP_NOTIFICATIONS_ADD,
...
export function backendCreate(formData: BackendUserCreatingFormData): Function {
  return (dispatch: Dispatch<BackendCreationAction>): Promise<void> =>
    create(formData, true).then((response) => {
      switch (response.status) {
        case 201:
...
export function backendUpdate(
  ...
  return (dispatch: Dispatch<BackendUpdatingAction>): Promise<void> =>
...
export function backendDestroy(id: string): Function {
  return (dispatch: Dispatch<BackendDestructionAction>): Promise<void> =>
